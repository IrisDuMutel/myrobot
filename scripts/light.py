...
def light():
    ...
    light_sub = message_filters.Subscriber('/light_Sensor/light_data',Illuminance)
    image_sub = message_filters.Subscriber('/camera2/color/image_raw',Image)
    #image_sub is necessary for getting light values

    ts = message_filters.TimeSynchronizer([light_sub,image_sub], 10)
