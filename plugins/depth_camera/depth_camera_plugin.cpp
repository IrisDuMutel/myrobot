...
GZ_REGISTER_SENSOR_PLUGIN(DCPlugin)
...
void DCPlugin::Advertise()
{
  ros::AdvertiseOptions point_cloud_ao =
    ros::AdvertiseOptions::create<sensor_msgs::PointCloud2 >(
      ...
      boost::bind( &DCPlugin::PointCloudConnect,this),
      boost::bind( &DCPlugin::PointCloudDisconnect,this),
  ...
  ros::AdvertiseOptions depth_image_ao =
    ros::AdvertiseOptions::create< sensor_msgs::Image >(
      ...
      boost::bind( &DCPlugin::DepthImageConnect,this),
      boost::bind( &DCPlugin::DepthImageDisconnect,this),
      ros::VoidPtr(), &this->camera_queue_);
  ...
  ros::AdvertiseOptions depth_image_camera_info_ao =
    ros::AdvertiseOptions::create<sensor_msgs::CameraInfo>(
        ...
        boost::bind( &DCPlugin::DepthInfoConnect,this),
        boost::bind( &DCPlugin::DepthInfoDisconnect,this),
        ros::VoidPtr(), &this->camera_queue_);
...
////////////////////////////////////////////////////////////////////////////////
// Increment count
void DCPlugin::PointCloudConnect()
{
...
////////////////////////////////////////////////////////////////////////////////
// Decrement count
void DCPlugin::PointCloudDisconnect()
{
  this->point_cloud_connect_count_--;
  (*this->image_connect_count_)--;
...
////////////////////////////////////////////////////////////////////////////////
// Increment count
void DCPlugin::DepthImageConnect()
{
...
////////////////////////////////////////////////////////////////////////////////
// Decrement count
void DCPlugin::DepthImageDisconnect()
{
  this->depth_image_connect_count_--;
}
...
////////////////////////////////////////////////////////////////////////////////
// Increment count
void DCPlugin::DepthInfoConnect()
{
  this->depth_info_connect_count_++;
}
////////////////////////////////////////////////////////////////////////////////
// Decrement count
void DCPlugin::DepthInfoDisconnect()
{
  this->depth_info_connect_count_--;
}
...
void DCPlugin::OnNewDepthFrame(const float *_image,
...
void DCPlugin::FillDepthImage(const float *_src)
{
  this->lock_.lock();
...
bool DCPlugin::FillPointCloudHelper(
...
// Fill depth information
bool DCPlugin::FillDepthImageHelper(
