...
void ContactPlugin::Load(sensors::SensorPtr _parent, sdf::ElementPtr _sdf)
{
  ...
  this->callback_queue_thread_ = boost::thread(
      boost::bind(&ContactPlugin::ContactQueueThread, this));

  // Listen to the update event. This event is broadcast every
  // simulation iteration.
  this->update_connection_ = this->parentSensor->ConnectUpdated(
     boost::bind(&ContactPlugin::OnContact, this));
...
void ContactPlugin::ContactQueueThread()
{
